...
export default function Example() {
  return (
    <>
        ...
        <div className="text-center mt-25 px-4 max-sm:px-2 max-md:px-4">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="#destinations"
              className="rounded-md bg-lime-500 px-3.5 mb-8 py-2.5 text-sm font-semibold text-black shadow-xs hover:bg-lime-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-600 max-sm:px-3 max-sm:py-2 max-sm:text-xs max-md:text-sm"
            >
              Start Your Journey
            </a>
          </div>
